...
export default function ItemQRCode({ itemId, itemName, type = "raw_material_update" }: { itemId: string; itemName: string; type?: string }) {
  // Encode a JSON payload for inventory update
  const qrData = JSON.stringify({ type, itemId });
